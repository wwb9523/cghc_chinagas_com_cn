				...
				<div class="content-box-content">
                    ...
                    <form method="post" action="<?php echo u("Category/doCommand");?>">
                    	<div class="notification information png_bg">
							...
							<div>
								删除分类会同时删除此分类下所有的子类，且不可恢复，请谨慎操作。受保护的类别为其它模块可能在使用中需要用到，尽量不要去删除，否则会导致错误。
							</div>
						</div>
						<table>
							<thead>
...
<?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><?php echo ($vo["str_repeat"]); ?><?php echo ($vo["title"]); ?> <?php echo (statusicon($vo["status"],1,$frontUrl,'images/icons/cross.png','隐藏')); ?> <?php echo (statusicon($vo["protected"],1,$frontUrl,'images/icons/lock.png','保护中')); ?> <!--判断是否为子栏目--><?php if($vo["parent_id"] == 0): ?><a href="<?php echo U('Category/insert',array('parentId'=>$vo['id']));?>"><img src="__PUBLIC__/Admin/images/icons/add.png" alt="添加子分类" align="absbottom" /></a><?php endif; ?></td>
									...
									<td>
										<!-- Icons -->
										 <a href="<?php echo U("Category/modify",array('id'=>$vo['id']));?>" title="编辑"><img src="__PUBLIC__/Admin/images/icons/pencil.png" alt="编辑" /></a>
                                         <a href="<?php echo U("Category/doCommand",array('operate'=>'delete','id'=>$vo['id']));?>" title="删除"><img src="__PUBLIC__/Admin/images/icons/cross.png" alt="删除" /></a>
									</td>
