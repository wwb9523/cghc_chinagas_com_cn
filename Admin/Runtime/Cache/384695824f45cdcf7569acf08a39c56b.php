    ...
    $(document).ready(function() {
        ...
        <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="<?php echo U('Course/index');?>"><span>
					<img src="__PUBLIC__/Admin/Images/icons/arrow_left_48.png" alt="icon" /><br />
					返回精品课程列表
				</span></a></li>
                <li><a class="shortcut-button" href="<?php echo U('Course/insert');?>"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                    <form method="post" action="<?php echo U('Course/doModify');?>" id="mainFrom" enctype="multipart/form-data">
					<div class="tab-content default-tab" id="tab1"> <!-- This is the target div. id must match the href of this div's tab -->
						<fieldset class="column-left"> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                            ...
                            <p>
                                <label>作者</label>
                                <input class="text-input large-input" type="text" name="author" id="author" value="<?php echo ($vo["author"]); ?>" />
                            </p>
							<p>
								<label>标题样式</label>
                        ...
                        <fieldset class="column-right">
                            <p>
                                <label>课程封面</label>
                                <input class="medium-input" type="file" name="attach_file" id="attach_file" /><?php if(($vo['attach'])  ==  "1"): ?><a href="__ROOT__/<?php echo ($UPLOADS); ?><?php echo ($vo["attach_image"]); ?>" target="_blank"><img src="__PUBLIC__/Admin/images/icons/image.png" align="absmiddle" /></a>　<input name="deleteImage" type="radio" value="1" />转换为普通新闻
