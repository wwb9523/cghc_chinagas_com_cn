				...
				<div class="content-box-content content-box-content-no-border">
					...
					<div class="tab-content default-tab"> <!-- This is the target div. id must match the href of this div's tab -->
                        <fieldset class="column-left">
                            <p>
								<label class="left">标题</label><input class="text-input medium-input" type="text" name="title" id="title" />
							</p>
                            <p>
...
*/
	...
	$("#pageSize").val('<?php echo ($_GET['pageSize']); ?>');
			...
			<ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="<?php echo U('Link/insert');?>"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                	<form method="post" action="<?php echo U('Job/doCommand');?>" id="mainFrom">
...
<?php if(isset($dataList)): ?><tfoot>
                            ...
                            <?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td><?php echo (statusicon($vo["status"],1,$frontUrl,'images/icons/cross_circle.png','隐藏')); ?><?php echo (statusicon($vo["status"],0,$frontUrl,'images/icons/accepted.png','显示')); ?><?php echo (attachstatus($vo["link_type"],'image',$frontUrl,'images/icons/image.png','图片')); ?></td>
									<td><input class="text-input large-input" name="link_url[]" id="link_url[]" value="<?php echo ($vo["link_url"]); ?>" /></td>
									<td><?php echo (date("Y-m-d",$vo["create_time"])); ?></td>
									<td>
										<!-- Icons -->
										<a href="<?php echo U('Link/modify',array('id'=>$vo['id']));?>" title="编辑"><img src="__PUBLIC__/Admin/images/icons/pencil.png" alt="编辑" /></a>
										<a href="<?php echo U('Link/doCommand',array('operate'=>'delete','id'=>$vo['id']));?>" title="删除"><img src="__PUBLIC__/Admin/images/icons/cross.png" alt="删除" /></a> 
									</td>
