	...
	function $doc(id){
        ...
        <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="<?php echo U("Category/insert");?>"><span>
						...
						<fieldset class="column-left"> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
							...
							<p>
								...
								<select name="parent_id" id="parent_id" onchange="style_show(this)">
                             		<?php echo (buildselect($dataList,0,$vo['id'])); ?>
          						</select>
							</p>
                            <div id="root_0" <?php if($vo['parent_id'] == 0): ?>style="display:"<?php else: ?>style="display:none"<?php endif; ?> >
                                <!--<p>
                                    <label>所属模块</label>
                                    <select name="module" id="module">
                                   		<option value="">选择模块</option>
                                	<?php if(is_array($module)): $i = 0; $__LIST__ = $module;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$row): $mod = ($i % 2 );++$i;?><option value="<?php echo ($row["module_name"]); ?>" <?php if(($row['module_name'])  !=  ""): ?><?php echo (selected($row["module_name"],$vo['module'])); ?><?php endif; ?>><?php echo ($row["module_title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                  	</select>
                                </p>-->
                            </div>
                            <p>
                                <label>关键字</label>
                                <input class="text-input medium-input" name="keyword" id="keyword" value="<?php echo ($vo["keyword"]); ?>" />
                            </p>
                            <p>
                                <label>简单描述</label>
                                <textarea class="text-input textarea" name="description" id="description" cols="79" rows="5"><?php echo ($vo["description"]); ?></textarea>
                            </p>
                        ...
                        <fieldset class="column-right">
                            ...
                            <p>
                                ...
                                <select name="protected" id="protected">
                              		<option value="0" <?php echo (selected($vo["protected"],0)); ?>>不保护分类</option>
