    ...
    $(document).ready(function() {
        ...
        <!-- Main Content Section with everything -->
			...
			<ul class="shortcut-buttons-set">
                ...
                <li><a class="shortcut-button" href="<?php echo U("Notice/index");?>"><span>
					<img src="__PUBLIC__/Admin/Images/icons/arrow_left_48.png" alt="icon" /><br />
					返回公告列表
				</span></a></li>
                <li><a class="shortcut-button" href="<?php echo U("Notice/insert");?>"><span>
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                    <form method="post" action="<?php echo U("Notice/doModify");?>" id="mainForm" enctype="multipart/form-data">
						...
						<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
							...
							<p>
								<label>标题样式</label>
                                    ...
                                    <input type="hidden" name="style_color" id="style_color" size="10" value="<?php echo (styleselected($vo["title_style_serialize"],'color')); ?>" />&nbsp;
                                    <input type="checkbox" name="checkbox" id="checkbox" value="bold" <?php echo (styleselected($vo["title_style_serialize"],'bold')); ?> /> 加粗
                                    <input type="checkbox" name="checkbox" id="checkbox" value="underline" <?php echo (styleselected($vo["title_style_serialize"],'underline')); ?> /> 下划线
							</p>
                            <!-- p>
                            	<label>起止时间</label>
                                <input name="start_time" type="text" class="text-input Wdate" id="start_time" style="width:160px"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false,readOnly:true})" value="<?php echo (date("Y-m-d",$vo["start_time"])); ?>"/>
								-
            					<input name="end_time" type="text" class="text-input Wdate" id="end_time" style="width:160px"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:false,readOnly:true})" value="<?php echo (date("Y-m-d",$vo["end_time"])); ?>"/>
                            </p -->
                                <label>详细说明</label>
					...
					<div class="tab-content" id="tab2">
                        <fieldset class="column-left">
                            ...
                            <p>
                                <label>上传附件</label>
                                <input class="medium-input" type="file" name="attach_file" id="attach_file" /><?php if(($vo['attach'])  ==  "1"): ?><a href="__ROOT__/<?php echo ($UPLOADS); ?><?php echo ($vo["attach_image"]); ?>" target="_blank"><img src="__PUBLIC__/Admin/images/icons/image.png" align="absmiddle" /></a>　<input name="deleteImage" type="radio" value="1" />删除附件
                        ...
                        <fieldset class="column-right">
							...
							<p>
                                ...
                                浏览 <input name="view_count" type="text" id="view_count" value="<?php echo ($vo["view_count"]); ?>" size="5" maxlength="12"  />
								排序 <input name="display_order" type="text" id="display_order" value="<?php echo ($vo["display_order"]); ?>" size="5" maxlength="12"  />
