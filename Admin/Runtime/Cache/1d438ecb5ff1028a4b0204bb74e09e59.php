        ...
        <!-- Main Content Section with everything -->
			...
			<div class="content-box"><!-- Start Content Box -->
				...
				<div class="content-box-content">
                	<form method="post" action="<?php echo U("Page/doCommand");?>" id="mainForm">
...
<?php if(isset($dataList)): ?><tfoot>
                            ...
                            <?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><input class="text-input large-input" name="title[]" id="title[]" value="<?php echo ($vo["title"]); ?>"></td>
                                    <td><?php echo (statusicon($vo["status"],1,$frontUrl,'images/icons/cross_circle.png','隐藏')); ?><?php echo (attachstatus($vo["attach"],1,$frontUrl,'images/icons/image.png','图片')); ?></td>
                                    <td><?php echo ($vo["link_label"]); ?></td>
									<td><?php echo (date("Y-m-d",$vo["create_time"])); ?></td>
									<td>
										<!-- Icons -->
										<a href="<?php echo U('Page/modify',array('id'=>$vo['id']));?>" title="编辑"><img src="__PUBLIC__/Admin/images/icons/pencil.png" alt="编辑" /></a>
										<a href="<?php echo U('Page/doCommand',array('operate'=>'delete','id'=>$vo['id']));?>" title="删除"><img src="__PUBLIC__/Admin/images/icons/cross.png" alt="删除" /></a> 
									</td>
